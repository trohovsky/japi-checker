...
public class DifferenceType {
	...
	public final static DifferenceType CLASS_CONTRACTED_SUPERCLASS_SET = new DifferenceType(Severity.ERROR, false, "The %s extends %s and not %s anymore", "");
	public final static DifferenceType CLASS_CONTRACTED_SUPERINTERFACE_SET = new DifferenceType(Severity.ERROR, false, "The %s is not implementing %s anymore", "");
