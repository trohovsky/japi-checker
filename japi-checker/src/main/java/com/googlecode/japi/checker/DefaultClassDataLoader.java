...
/**
 * Basic implementation of the ClassDataLoader. It populates itself thanks to the read method.
 */
class DefaultClassDataLoader implements ClassDataLoader<ClassData> {
	...
	/**
	 * Read a set of classes via this ClassDataLoader. The idea is similar to the regular Java ClassLoader but for
	 * ClassData type of objects.
	 *
