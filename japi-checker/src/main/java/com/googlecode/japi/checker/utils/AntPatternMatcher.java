...
/**
 * This class will convert a Ant pattern (containing **) into a regular expression. It allows to run each matching
 * independently.
 *
...
public class AntPatternMatcher {
	...
	/**
	 * Convert an Ant Pattern into a regular expression. It supports the following patterns: '**': matches zero or
	 * several subdirs. '*': matches zero or several characters. '?': matches one character.
	 *
